...
class DataBase:
    ...
    async def start(cls):
        ...
        cls._queries['closes_1m'] = await cls._conn.prepare('''
                            SELECT
                              ts AS "time",
                              px_close
                            FROM ohlc
        ...
        cls._queries['funding_rates'] = ''
        # await cls._conn.prepare('''
        #                                         SELECT
        #                                           ts AS "time",
        #                                           funding_rate
        #                                         FROM funding_rates
    ...
    @classmethod
    async def get_funding_rates(cls, symbol) -> pd.DataFrame:
        return await cls._fetch_by_symbol('funding_rates', symbol)
