...
class Spread(TimeSeries):
    ...
    def __init__(self, leg1, leg2, op='-'):
        ...
        self.set_default_symbol('SPREAD')

    async def load(self, start: Optional[str] = None, end: Optional[str] = None, resolution='1m'):
    ...
    def plot(self):
        ...
        with plt.rc_context({'axes.edgecolor': 'white',
            ...
            fig, axes = plt.subplots(nrows=4, sharex='all', figsize=(12, 6),
