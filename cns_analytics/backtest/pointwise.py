...
async def main():
    ...
    for s1, s2 in pairs:
        ...
        axes[0][0]._title.set_text('Total Profit')
        axes[0][0].plot(labels, total_profit)
        axes[1][0]._title.set_text('Mean Profit')
        axes[1][0].plot(labels, mean_profit)
        axes[2][0]._title.set_text('Deals count')
        axes[2][0].plot(labels, count)
        axes[0][1]._title.set_text('Reval')
        axes[0][1].plot(reval)
        axes[1][1]._title.set_text('Spread')
